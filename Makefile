...
#OPT ?= -g -g2              # (B) Debug mode, w/ full line-level debugging symbols
...
#CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT) -DSQLITE_DISABLE_JOURNAL
#CCFLAGS += -I. -I./include $(PLATFORM_CCFLAGS) $(OPT) -DSQLITE_DISABLE_JOURNAL


#CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT)
#CCFLAGS += -I. -I./include $(PLATFORM_CCFLAGS) $(OPT)

#CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT) -DSQLITE_ENABLE_MEMJOURNAL 
#CCFLAGS += -I. -I./include $(PLATFORM_CCFLAGS) $(OPT) -DSQLITE_ENABLE_MEMJOURNAL 


#CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT)  -DSQLITE_ENABLE_ATOMIC_WRITE 
#CCFLAGS += -I. -I./include $(PLATFORM_CCFLAGS) $(OPT)  -DSQLITE_ENABLE_ATOMIC_WRITE

#CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT)  -DSQLITE_ENABLE_ATOMIC_WRITE -DSQLITE_ENABLE_MEMJOURNAL
#CCFLAGS += -I. -I./include $(PLATFORM_CCFLAGS) $(OPT)  -DSQLITE_ENABLE_ATOMIC_WRITE -DSQLITE_ENABLE_MEMJOURNAL


#CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT)  -D_ENABLE_WAL
#CCFLAGS += -I. -I./include $(PLATFORM_CCFLAGS) $(OPT)  -D_ENABLE_WAL

CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT)  -D_ENABLE_WAL -DSQLITE_ENABLE_MEMJOURNAL -D_DELAYFREE
CCFLAGS += -I. -I./include $(PLATFORM_CCFLAGS) $(OPT)  -D_ENABLE_WAL -DSQLITE_ENABLE_MEMJOURNAL -D_DELAYFREE
CFLAGS += -D_DELAYFREE


LDFLAGS += $(PLATFORM_LDFLAGS)
LIBS += $(PLATFORM_LIBS) -lhoard
...
BENCHMARKS = db_bench_sqlite3 db_bench_mem_sqlite3 #db_bench_tree_db
...
db_bench_sqlite3: doc/bench/db_bench_sqlite3.o $(LIBOBJECTS) $(TESTUTIL)
	$(CC) $(CFLAGS) -c sqlite/sqlite3.c   
	$(CXX) $(LDFLAGS) doc/bench/db_bench_sqlite3.o $(LIBOBJECTS) $(TESTUTIL) -o $@ sqlite3.o $(LIBS) -ldl #-lsqlite3

db_bench_mem_sqlite3: doc/bench/db_bench_mem_sqlite3.o $(LIBOBJECTS) $(TESTUTIL)
	$(CC) $(CFLAGS) -c sqlite/sqlite3.c    
	$(CXX) $(CFLAGS)  $(LDFLAGS) doc/bench/db_bench_mem_sqlite3.o $(LIBOBJECTS) $(TESTUTIL) -o $@ sqlite3.o $(LIBS) -ldl #-lsqlite3
